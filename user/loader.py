# Write user-space loader and API (Python, using BCC + Flask)
loader_py = r"""
#!/usr/bin/env python3
"""
loader_py += r'''
...
with open(os.path.join(base_dir, "user", "loader.py"), "w") as f:
    f.write(loader_py.strip() + "\n")
...
with open(os.path.join(base_dir, "user", "config", "policy.yaml"), "w") as f:
    f.write(policy_yaml.strip() + "\n")

"user-space loader and policy written"
